...
### Functions
#######################################
def _make_locked_flag(sigs:TimeSeriesDict, round:bool=False) -> DataQualityFlag:
    '''
    Core function for making DataQualityFlag about LOCKED segments.
    ...
    threshold = TimeSeries([100.0], unit='V', name='threshold:100.0')
...
def _make_unlocked_flag(sigs:TimeSeriesDict, round:bool=False) -> DataQualityFlag:
    '''
    Core function for making DataQualityFlag about UNLOCKED segments.
