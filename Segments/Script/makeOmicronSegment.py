...
keys = ['CAL_CS_PROC_DARM_DISPLACEMENT_DQ', 'PEM_SEIS_EXV_GND_X_OUT_DQ','PEM_SEIS_EXV_GND_Y_OUT_DQ','PEM_SEIS_EXV_GND_Z_OUT_DQ','PEM_SEIS_EYV_GND_X_OUT_DQ','PEM_SEIS_EYV_GND_Y_OUT_DQ','PEM_SEIS_EYV_GND_Z_OUT_DQ','PEM_SEIS_IXV_GND_X_OUT_DQ','PEM_SEIS_IXV_GND_Y_OUT_DQ','PEM_SEIS_IXV_GND_Z_OUT_DQ',]
snrs = {}
#snrs['CAL_CS_PROC_C00_STRAIN_DBL_DQ'] = [20,100]
snrs['CAL_CS_PROC_DARM_DISPLACEMENT_DQ'] = [20,100]
for key in keys:
    if "PEM_SEIS" in key:
        snrs[key] = [20]
