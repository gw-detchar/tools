...
parser.add_argument('--kashiwa',help='Flag to run on Kashiwa server.',action='store_false')
...
#           "IMC-CAV_TRANS_OUT_DQ":35,
           ...
           "LSC-REFL_PDA1_RF45_I_ERR_DQ":10,
...
#        else:
    ...
    strtmp=""
    #    strtime=str(int(time))+"."+str(tmpstart).split(".")[1]
