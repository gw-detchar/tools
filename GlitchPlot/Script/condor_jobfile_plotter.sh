...
#	fft30=${sampling[tmp2]}
    ...
    sampling=( 1 0.5 0.25 0.125 0.0625 0.03125 0.015625 0.007813 0.003906 0.001953 0.000977 0.000488 0.000244 0.000123 0.000061 )
...
#    chmod u+x $runlock
	...
	# timeseries job
	{
	    ...
	    echo "Arguments = -c ${chlist[@]} -s $gpsstart -e $gpsend -o ${outdir} -i $channel ${optiontime} -t ${chlist[0]}_Timeseries --nolegend --dpi 50 --blow ${maxf} --bhigh ${minf}"
	    echo "Queue"
	} >> job_${nametime}.sdf
