...
cat $1 | while read gpstime channel min_duration max_duration bandwidth dump1 dump2 dump3 dump4
do
    ...
    index="plotter_"$gpstime$channel
...
#    condir="/users/.ckozakai/KashiwaAnalysis/analysis/code/gwpy/trigger/plotter"
    ...
    {
	echo $gpstime $channel $min_duration $max_duration $bandwidth $dump1 $dump2 $dump3 $dump4 
