...
#X-arm
channels=("LSC_CARM_SERVO_MIXER_DAQ_OUT_DQ" "IMC_SERVO_SLOW_DAQ_OUT_DQ" "AOS_TMSX_IR_PD_OUT_DQ" "IMC_CAV_TRANS_OUT_DQ" "PSL_PMC_TRANS_DC_OUT_DQ" "CAL_CS_PROC_IMC_FREQUENCY_DQ")
#IMC
