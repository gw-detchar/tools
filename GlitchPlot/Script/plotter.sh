...
#channels=("CAL_CS_PROC_DARM_DISPLACEMENT_DQ" "CAL_CS_PROC_C00_STRAIN_DBL_DQ")
#channels=("CAL_CS_PROC_DARM_DISPLACEMENT_DQ")
#channels=("CAL_CS_PROC_C00_STRAIN_DBL_DQ" "CAL_CS_PROC_SRCL_DISPLACEMENT_DQ" "CAL_CS_PROC_MICH_DISPLACEMENT_DQ_OMICRON" "CAL_CS_PROC_XARM_FREQUENCY_DQ_OMICRON")
#channels=("CAL_CS_PROC_DARM_DISPLACEMENT_DQ" "CAL_CS_PROC_MICH_DISPLACEMENT_DQ_OMICRON" "CAL_CS_PROC_XARM_FREQUENCY_DQ_OMICRON")
channels=("CAL_CS_PROC_C00_STRAIN_DBL_DQ")
#IMC
