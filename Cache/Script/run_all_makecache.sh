...
Error        = /home/detchar/log/cache_regenerate.err
Output       = /home/detchar/log/cache_regenerate.out
...
do
    ...
    if [ ! -d /data/KAGRA/raw/full/${i} ]; then
	echo "*** no directory"
	flag=1
    fi
	...
	echo "Executable   = /disk/home/detchar/git/kagra-detchar/tools/Cache/Script/makeCache.sh" >> $submit
